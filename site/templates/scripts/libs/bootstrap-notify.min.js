! function(t) {
    ...
    function s(s) {
        ...
        return t('[data-notify="container"]').each(function(e, n) {
            var a = t(n),
                ...
                l = a.find('[data-notify="message"]').html().trim(),
                r = o === t("<div>" + s.settings.content.title + "</div>").html().trim(),
                d = l === t("<div>" + s.settings.content.message + "</div>").html().trim(),
    ...
    String.format = function() {
                ...
                update: function(s, i) {
                    ...
                    for (var n in e) switch (n) {
                        ...
                        case "icon":
                            ...
                            "class" === t.settings.icon_type.toLowerCase() ? a.removeClass(t.settings.content.icon).addClass(e[n]) : "material-icon" === t.settings.icon_type.toLowerCase() ? a.removeClass(t.settings.content.icon).addClass("material-icons").html(e[n]) : (a.is("img") || a.find("img"), a.attr("src", e[n])), t.settings.content.icon = e[s];
                            break;
                        case "progress":
        ...
        setIcon: function() {
            "class" === this.settings.icon_type.toLowerCase() ? this.$ele.find('[data-notify="icon"]').addClass(this.settings.content.icon) : "material-icon" === this.settings.icon_type.toLowerCase() ? this.$ele.find('[data-notify="icon"]').addClass("material-icons").html(this.settings.content.icon) : this.$ele.find('[data-notify="icon"]').is("img") ? this.$ele.find('[data-notify="icon"]').attr("src", this.settings.content.icon) : this.$ele.find('[data-notify="icon"]').append('<img src="' + this.settings.content.icon + '" alt="Notify Icon" />')
        },
    ...
    icon_type: "class",
    template: 
    '<div class="card bg-transparent" data-notify="container"  role="alert">' +
        '<div class="container">' + 
            '<div class="row">' +
                '<div class="col-1 d-flex justify-content-center align-items-center bg-{0} text-white">' +
                    '<span data-notify="icon"></span>' +
                '</div>' +
                '<div class="col-11 alert-{0}">' +
                    '<span data-notify="title" class="h5">{1}</span>' +
                    '<div class="notify-message"><span data-notify="message">{2}</span></div>' +
